    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/properties/me", "/api/properties/me/*").hasRole("AGENT")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/properties/*/images").hasRole("AGENT")
                        .requestMatchers(HttpMethod.PATCH, "/api/properties/*/images/*").hasRole("AGENT")
                        .requestMatchers(HttpMethod.DELETE, "/api/properties/*/images/*").hasRole("AGENT")
